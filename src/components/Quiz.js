        ...
        <div>
            ...
            <div className='quiz-container' style={{ width: windowWidth }}>
                {(this.props.store.currentQuestionIdx + 1) > this.props.store.questions.length ? (
                    ...
                    <div>
                        <div style={{textAlign: 'center'}}><img src={queImg} className="qa-logo" alt="logo" style={{width: '175px'}}/></div>
                        <h2 style={{margin: '25px', fontSize: '1.35rem'}}>{"Q" + queNumber + ": " + this.props.store.questions[this.props.store.currentQuestionIdx].question}</h2>
